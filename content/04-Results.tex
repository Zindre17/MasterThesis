...
This section will present the results, in regards to development and evaluation. The part about development will briefly explain the scenes turned out. The evaluation part will present evaluation results without any interpretation, just numbers. The interpretation of the evaluation results will come in the next chapter: Discussion. 

\subsection{The Prototype}
The development was halted in mid May, 2019, to give time for the evaluation and writing the report. The final version of the prototype can be seen in \href{https://youtu.be/VUHdUxoRH5Y}{this} video\cite{UniVRsity}. It shows how the prototype works, how it looks, and a general look into all its content. For more details the code can be found on \href{https://github.com/Zindre17/UniVRsity}{Github}\cite{Github}. 
