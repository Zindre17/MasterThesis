...
\begin{itemize}
    \item \textbf{RQ1}: Is the new prototype improved compared to the previous version?
    \item \textbf{RQ2}: Do people think VR is suited in a school or learning setting?
    \item \textbf{RQ3}: Will the developed prototype indicate that using VR might be suited for teaching/learning?
\end{itemize}
