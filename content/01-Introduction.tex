...
\begin{itemize}
    \item \textbf{RQ1}: Will the developed prototype indicate that using VR might be suited for teaching/learning?
    \item \textbf{RQ2}: Do people think VR is suited in a school or learning setting?
    \item \textbf{RQ3}: Is the new prototype improved compared to the previous version?
\end{itemize}

 
\subsection{Contributions}

 The contributions of this project is mainly the prototype itself, and some of the data gathered through the testing. The code of the prototype can be reused or extended by anyone who wishes to do so, as it is hosted publicly on Github\cite{Github}. A playable build of the current version will be available for download from a google drive link\cite{Build}. The test data revealed that all the participants believe VR is suited for learning, and most thought an application similar to the prototype could be useful as well. 
 
\subsection{Thesis Outline}
The structure of this article is as follows. The next chapter is the background. This chapter will present some theory about learning, learning combined with technology, and games. It will also present the technologies used in this project and the software considered and used. Method, the third chapter, will present the planning of the prototype, the tools for implementing the prototype, and the plan for how to perform the testing. The fourth chapter, Results, will describe how the prototype turned out, show some insight into how the prototype was made, and reveal the results of the testing. After that you can read about my thoughts around these results, and ideas for how things could have been done differently or what can be done in the future, in the fifth chapter, Discussion. In the final chapter, six, the conclusion is presented.