...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth, totalheight=0.4\textheight, keepaspectratio=true]{images/unit3d.png}
\caption{Unity logo}
\label{fig:unity}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth, totalheight=0.4\textheight, keepaspectratio=true]{images/unreal.png}
...
\subsection{Multimedia Learning Theories} \label{sec:MLT}
